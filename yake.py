...
language = "en"
max_ngram_size = 3
dedupliucation_threshold = 0.9
numOfKeywords = 30
custom_kw_extractor = yake.KeywordExtractor(lan=language, n=max_ngram_size, dedupLim=dedupliucation_threshold, top=numOfKeywords, features=None)
